...
public class Knight extends ChessPiece
{
	...
	public void draw(Graphics g)
	{
		...
		final int width = 40;
		try {
			knight_b = ImageIO.read(new File("C:\\workspace\\chess\\src\\client\\gui\\knight_black.png"));
			knight_w = ImageIO.read(new File("C:\\workspace\\chess\\src\\client\\gui\\knight_white.png"));
		} catch (IOException e) {
			e.printStackTrace();
		} 
		if(getColor())
