...
public class Rook extends ChessPiece
{
	...
	public void draw(Graphics g)
	{
		...
		final int width = 40;
		try {
			rook_b = ImageIO.read(new File("C:\\workspace\\chess\\src\\client\\gui\\rook_black.png"));
			rook_w = ImageIO.read(new File("C:\\workspace\\chess\\src\\client\\gui\\rook_white.png"));
		} catch (IOException e) {
			e.printStackTrace();
		} 
		if(getColor())
